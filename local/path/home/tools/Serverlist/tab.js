...
// servers/home/tools/Serverlist/tab.tsx
...
function DrawerButton({ bbContentContainer: bbContentContainer2 }) {
  const cleanUp = (0, import_react12.useContext)(CleanupContext);
  const [open, setOpen] = (0, import_react12.useState)(false);
  const [bbContainerStyle, setBBContainerStyle] = (0, import_react12.useState)("");
  ...
  return /* @__PURE__ */ import_react12.default.createElement("div", { id: "serverlist-drawer-button", className: [
    "MuiButtonBase-root MuiListItem-root MuiListItem-gutters MuiListItem-padding MuiListItem-button",
    open ? classNameMaps.drawerButton.active : classNameMaps.drawerButton.inactive
  ].join(" "), onClick: () => setOpen(true) }, /* @__PURE__ */ import_react12.default.createElement(ButtonStyled, { open }));
}
function ButtonStyled({ open }) {
  return /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, /* @__PURE__ */ import_react12.default.createElement("div", { className: "MuiListItemIcon-root css-1f8bwsm" }, /* @__PURE__ */ import_react12.default.createElement(
    "svg",
    {
      className: [
    ...
    /* @__PURE__ */ import_react12.default.createElement("g", { id: "Page-1", "stroke-width": "1", "fill-rule": "evenodd" }, /* @__PURE__ */ import_react12.default.createElement("g", { id: "icon-shape" }, /* @__PURE__ */ import_react12.default.createElement("path", { d: "M0,2 L20,2 L20,18 L0,18 L0,2 Z M2,4 L18,4 L18,16 L2,16 L2,4 Z M6,4 L8,4 L8,16 L6,16 L6,4 Z M12,4 L14,4 L14,16 L12,16 L12,4 Z", id: "Combined-Shape" })))
  )), /* @__PURE__ */ import_react12.default.createElement("div", { className: "MuiListItemText-root css-1tsvksn" }, /* @__PURE__ */ import_react12.default.createElement("p", { className: [
    "MuiTypography-root MuiTypography-body1",
    open ? classNameMaps.text.active : classNameMaps.text.inactive
  ].join(" ") }, "Serverlist")), /* @__PURE__ */ import_react12.default.createElement("span", { className: "MuiTouchRipple-root css-w0pj6f" }));
}
...
async function main2(ns) {
  ...
  mpButton.mount(/* @__PURE__ */ import_react13.default.createElement(DrawerButton, { bbContentContainer: bbContentContainer() }), drawerButton);
  mpButton.addCleanup(() => {
    deleteElement("serverlist-drawer-button-container");
  });
  ...
  return mpApp.mount(/* @__PURE__ */ import_react13.default.createElement(ServerlistUI, null), serverlistContentContainer);
}
