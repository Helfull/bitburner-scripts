...
// servers/home/startup-tools/stock.starter.ts
async function main(ns) {
  ...
  await startUp.idle(() => !ns.stock.hasWSEAccount() || !ns.stock.hasTIXAPIAccess() || ns.getServerMoneyAvailable("home") < 1e7);
  await startUp.start(ns, "imported/mystocks.js", "hybrid", "fundself");
}
export {
  main
};
